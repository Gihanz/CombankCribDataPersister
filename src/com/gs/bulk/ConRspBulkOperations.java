...
public class ConRspBulkOperations {
		
	public static Logger log = Logger.getLogger(ConRspBulkOperations.class);
	Timestamp created = new Timestamp(System.currentTimeMillis());
	XPath xPath = XPathFactory.newInstance().newXPath();
	
		//================ Setting Demographic Details ================//
		public void insrtDemographicDetails(Document doc, String b_consumerDetails, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_consumerDetails).evaluate(doc, XPathConstants.NODESET);
			...
			String telephoneAreaCode = (consumerDetails.getElementsByTagName("AREA_CODE").getLength() > 0) ? consumerDetails.getElementsByTagName("AREA_CODE").item(0).getTextContent() : "-";
		...
		public void insrtEmploymentDetails(Document doc, String b_employmentDetails, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_employmentDetails).evaluate(doc, XPathConstants.NODESET);
			...
			for(int x=0; x<nodeList.getLength(); x++) {
				...
				if(employmentDetails.hasChildNodes()) {	
					...
					String businessName = (employmentDetails.getElementsByTagName("BUSINESS_NAME").getLength() > 0) ? employmentDetails.getElementsByTagName("BUSINESS_NAME").item(0).getTextContent().replace("'", "`") : "-";
		...
		public void insrtRelationshipDetails(Document doc, String b_relationships, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			for(int x=0; x<nodeList.getLength(); x++) {
				...
				if(relationships.hasChildNodes()) {		
					...
					String phone                = (relationships.getElementsByTagName("PHONE_NO").getLength() > 0) ? relationships.getElementsByTagName("PHONE_NO").item(0).getTextContent() : "-";
					String fax                  = (relationships.getElementsByTagName("FAX_NO").getLength() > 0) ? relationships.getElementsByTagName("FAX_NO").item(0).getTextContent() : "-";
		...
		public void insrtSettledCFDetails(Document doc, String b_settledCFDetails, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_settledCFDetails).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtLendingInstInquiries(Document doc, String b_lendingInstInquiries, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_lendingInstInquiries).evaluate(doc, XPathConstants.NODESET);
			...
			for(int x=0; x<nodeList.getLength(); x++) {
				...
				if(lendingInstInquiries.hasChildNodes()) {	
					...
					String cfType      = (lendingInstInquiries.getElementsByTagName("CREDIT_TYPE").getLength() > 0) ? lendingInstInquiries.getElementsByTagName("CREDIT_TYPE").item(0).getTextContent() : "-";
		...
		public SearchResults getSearchResults(Document doc) {
			...
			for(int x=0; x<doc.getElementsByTagName("SEARCH-RESULT-ITEM").getLength(); x++) {
				...
				if(searchResultItem.hasChildNodes()) {
					...
					Element surrogate = (Element) searchResultItem.getElementsByTagName("SURROGATE").item(0);
					srchRsltItem.setSurrogate(null);
					srchRsltItem.setSurrogateMatched(null);					
				}
