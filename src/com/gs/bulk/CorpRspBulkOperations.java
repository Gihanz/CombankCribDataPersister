...
public class CorpRspBulkOperations {
	
	public static Logger log = Logger.getLogger(CorpRspBulkOperations.class);
	Timestamp created = new Timestamp(System.currentTimeMillis());
	XPath xPath = XPathFactory.newInstance().newXPath();
			
		//================ Setting Firmographic Details ================//
		public void insrtFirmographicDetails(Document doc, String b_commercialDetails, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_commercialDetails).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtMailingAddresses(Document doc, String b_mailingAddresses, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_mailingAddresses).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtPermanentAddresses(Document doc, String b_permanentAddresses, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_permanentAddresses).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtReportedNames(Document doc, String b_reportedNames, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_reportedNames).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtRelationshipDetails(Document doc, String b_relationships, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_relationships).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtRelationshipAddressDetails(Document doc, String b_relationshipAddresses, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_relationshipAddresses).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtSettledCFDetails(Document doc, String b_settledCFDetils, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_settledCFDetils).evaluate(doc, XPathConstants.NODESET);
	
			for(int x=0; x<nodeList.getLength(); x++) {
				  			
				Element settledCFDetils = (Element) nodeList.item(x);
				if(settledCFDetils.hasChildNodes()) {	
					String currency              = (settledCFDetils.getElementsByTagName("Currency").getLength() > 0) ? settledCFDetils.getElementsByTagName("Currency").item(0).getTextContent() : "-";
					String cfType                = (settledCFDetils.getElementsByTagName("CF_Type").getLength() > 0) ? settledCFDetils.getElementsByTagName("CF_Type").item(0).getTextContent() : "-";
					String noOfCfasBorrower      = (settledCFDetils.getElementsByTagName("Total_no_of_credit_facilities_BRW").getLength() > 0) ? settledCFDetils.getElementsByTagName("Total_no_of_credit_facilities_BRW").item(0).getTextContent() : null;
					String amtGrantedasBorrower  = (settledCFDetils.getElementsByTagName("Total_Amt_Granted_BRW").getLength() > 0) ? settledCFDetils.getElementsByTagName("Total_Amt_Granted_BRW").item(0).getTextContent() : null;
					String noOfCfasGuarantor     = (settledCFDetils.getElementsByTagName("Total_no_of_credit_facilities_GRT").getLength() > 0) ? settledCFDetils.getElementsByTagName("Total_no_of_credit_facilities_GRT").item(0).getTextContent() : null;
					String amtGrantedasGuarantor = (settledCFDetils.getElementsByTagName("Total_Amt_Granted_GRT").getLength() > 0) ? settledCFDetils.getElementsByTagName("Total_Amt_Granted_GRT").item(0).getTextContent() : null;
		...
		public void insrtSettledCFSummary(Document doc, String b_settledCFSummary, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_settledCFSummary).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtLendingInstInquiries(Document doc, String b_leadingInstInquiries, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_leadingInstInquiries).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtInquiriesBySubject(Document doc, String b_inqBySubject, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_inqBySubject).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtCreditFacility(Document doc, String b_creditFacility, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_creditFacility).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtCreditFacilityDetails(Document doc, String b_cFDetails, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_cFDetails).evaluate(doc, XPathConstants.NODESET);
		...
		//================ Last 24 Months ================//
		public void insrtLast24Months(Document doc, String b_last24Months, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_last24Months).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtCFForLast24Months(Document doc, String b_cfFor24Months, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_cfFor24Months).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtDisputeDetails(Document doc, String b_disputeDetails, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			    
			String compiledQuery = "INSERT INTO CRIB_CORP_DISPUTE_DETAILS (REQUEST_DETAIL_ID, DESCRIPTION, IS_ACTIVE, CREATED, CREATED_BY) " +
		   			   			   "VALUES (?, ?, ?, ?, ?)";
			PreparedStatement pstmt = conn.prepareStatement(compiledQuery);
			
			NodeList nodeList = (NodeList) xPath.compile(b_disputeDetails).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtPotAndCurrLiabilitiesHeader(Document doc, String b_potAndCurrLiabilitiesHeader, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_potAndCurrLiabilitiesHeader).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtPotAndCurrLiabilities(Document doc, String b_potAndCurrLiabilities, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_potAndCurrLiabilities).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtCFOfGlanceStatus(Document doc, String b_cFOfGlanceStatus, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_cFOfGlanceStatus).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtDishonChequeSummary(Document doc, String b_dishonChequeSummary, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_dishonChequeSummary).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtDishonChequeDetails(Document doc, String b_dishonChequeDetails, int requestDetailId, String username, Connection conn) throws SQLException, ParseException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_dishonChequeDetails).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtEconActivityHistory(Document doc, String b_econActivityHistory, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_econActivityHistory).evaluate(doc, XPathConstants.NODESET);
		...
		public void insrtCatalogueDescription(Document doc, String b_catalogueDescription, int requestDetailId, String username, Connection conn) throws SQLException, XPathExpressionException {
			...
			NodeList nodeList = (NodeList) xPath.compile(b_catalogueDescription).evaluate(doc, XPathConstants.NODESET);
